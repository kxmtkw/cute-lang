...
OPERATOR_BINDING_POWER: dict[Union[BinaryOpType, UnaryOpType], tuple[float, float]] = {
	...
	BinaryOpType.And:    (1.0, 1.1),

	BinaryOpType.BitOr:  (2.0, 2.1),
	BinaryOpType.BitXor: (3.0, 3.1),
	BinaryOpType.BitAnd: (4.0, 4.1),

	BinaryOpType.Eq:     (5.0, 5.1),
	BinaryOpType.Neq:    (5.0, 5.1),

	BinaryOpType.Lt:     (6.0, 6.1),
	BinaryOpType.Lte:    (6.0, 6.1),
	BinaryOpType.Gt:     (6.0, 6.1),
	BinaryOpType.Gte:    (6.0, 6.1),

	BinaryOpType.Shl:    (7.0, 7.1),
	BinaryOpType.Shr:    (7.0, 7.1),

	BinaryOpType.Add:    (8.0, 8.1),
	BinaryOpType.Sub:    (8.0, 8.1),

	BinaryOpType.Mul:    (9.0, 9.1),
	BinaryOpType.Div:    (9.0, 9.1),
	BinaryOpType.Mod:    (9.0, 9.1),

	UnaryOpType.Negate:  (11.1, 11.0),
	UnaryOpType.Not:     (11.1, 11.0),
	UnaryOpType.BitNot:  (11.1, 11.0),

	BinaryOpType.Access: (12.0, 12.1),
}
